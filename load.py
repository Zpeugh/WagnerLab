# -*- coding: utf-8 -*-
"""
Created on Tue Feb 23 16:21:30 2016
...
class load():
    ...
    def combineRuns(run1, run2, run3):
        ...
        #TODO: Ask Dr. wagner about the movie times to index the movie.         
        #finalDataset.sa["time_coords"] = np.arange(97.5:625)
    ...
    def load_2010_data():
        ...
        for index, subject in enumerate(subjects):
            ...
            run1 = fmri_dataset( BASE_PATH + subject + run_path.format(1) )
            run2 = fmri_dataset( BASE_PATH + subject + run_path.format(2) )
            run3 = fmri_dataset( BASE_PATH + subject + run_path.format(3) )
